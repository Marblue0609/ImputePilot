...
from ImputePilot_api.ImputePilot_code.FeaturesExtraction.AbstractFeaturesExtractor import AbstractFeaturesExtractor
...
class KatsFeaturesExtractor(AbstractFeaturesExtractor):
    ...
    def extract_from_timeseries(self, timeseries):
        ...
        """
        TimeSeriesData, TsFeatures = self._require_kats()
    ...
    def _require_kats():
        ...
        try:
            ...
            raise ImportError(
                "Kats is not installed. Install kats to enable KatsFeaturesExtractor."
            ) from exc
        return TimeSeriesData, TsFeatures
